...
Brian Kernighan Algorithm : When 1 is subtracted from any number then all the bits after rightmost bit having value 1(set bit) and including the right-most set bit itself gets flipped. Repeat this again and again untill all the bits converted to unset bits or number converts to 0.
